...
TOF_Scope1=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/Scope1/Scope1_56028.csv', '', 'delimiter', ',', ... 
...
%%
dt_1_1=192,5;%ns   <---- time shift of the photopeak
...
%%
dt_2_1=179.5; %ns   <---- time shift of the photopeak
...
%%
dt_3_1=311.3; %ns   <---- time shift of the photopeak
...
%%
dt_4_1=144.3; %ns   <---- time shift of the photopeak
...
Ch1_2=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/Scope2/C1Scope2_5602800000.txt', '', 'delimiter', ',', ... 
                'headerlines',5,'emptyvalue', NaN);
Ch2_2=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/Scope2/C2scope2_5602800000.txt', '', 'delimiter', ',', ... 
                'headerlines',5,'emptyvalue', NaN);
Ch3_2=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/Scope2/C3scope2_5602800000.txt', '', 'delimiter', ',', ... 
              'headerlines',5,'emptyvalue', NaN);
Ch4_2=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/Scope2/C4scope2_5602800000.txt', '', 'delimiter', ',', ... 
                'headerlines',5,'emptyvalue', NaN);
...
%%
dt_1_2=147.7;%ns   <---- time shift of the photopeak
...
%%
dt_3_2=151.9; %ns   <---- time shift of the photopeak
...
set(gca,'fontsize',20)
 ...
 TOF_Scope3=textread('/Users/Beatrice/Desktop/Dottorato/PALS2020/analisi dati/TOF/TOF_DATA/05112020/scope3/scope3_56028.csv', '', 'delimiter', ',', ... 
...
%%
dt_1_3=102.6;%ns   <---- time shift of the photopeak
...
%% Ch2 -> identify the time shift dt (ns) to shift photopeak to zero and put it as input in the next section
figure;
plot(Ch2_3(:,1)*10^9,smooth(Ch2_3(:,2),1))
%%
dt_2_3=132,8; %ns   <---- time shift of the photopeak
...
plot(time_Ch3_1,Ch3_1(:,2),'DisplayName', 'D-poly 0° b')
...
plot(time_Ch3_1/d3_1,Ch3_1(:,2),'DisplayName','D-poly 0° b')
...
plot(EP_3_1,smooth(proton_3_1(:,2),1),'DisplayName','D-poli 0° b')
...
plot(EP_3_1,I_3_1,'DisplayName','D-poli 0° b')
